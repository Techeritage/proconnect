...
const Blog = () => {
  return (
    <section className="myContainer">
      ...
      <div className="mt-10 myFlex gap-4 overflow-x-scroll">
        <div className="border border-gray-300 min-w-[300px]  max-w-[300px] rounded-2xl p-2">
          ...
          <p className="line-clamp-2 mt-2">
            Discover actionable tips to stand out in a competitive market and
            secure the best candidates for your team.
          </p>
